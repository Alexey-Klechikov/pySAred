...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.checkBox_red_divide_by_monitor = QtWidgets.QCheckBox(self.tab_reductions)
        self.checkBox_red_divide_by_monitor.setGeometry(QtCore.QRect(10, 10, 131, 18))
        self.checkBox_red_divide_by_monitor.setFont(font_ee)
        self.checkBox_red_divide_by_monitor.setObjectName("checkBox_red_divide_by_monitor")
        self.checkBox_red_divide_by_monitor.setText("Divide by monitor")
        ...
        self.graphicsView_sfm_detector_roi = pg.PlotWidget(self.tab_sfm_detector_image, viewBox=pg.ViewBox())
        ...
        self.graphicsView_sfm_detector_image.view.getViewBox().setXLink(self.graphicsView_sfm_detector_roi)
        ...
        self.graphicsView_sfm_2dmap = pg.ImageView(self.tab_sfm_2dmap, view=pg.PlotItem())
        ...
        self.action_version.setText("Version 1.4.1")
...
class GUI(Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.checkBox_red_divide_by_monitor.stateChanged.connect(self.load_reflectivity_preview)
            ...
            with h5py.File(self.tableWidget_scans.item(i, 2).text(), 'r') as FILE:
                ...
                for detector in INSTRUMENT.get('detectors'):
                    ...
                    for index, th in enumerate(th_list):
                        ...
                        if self.checkBox_red_divide_by_monitor.isChecked():
    ...
    def draw_2D_map(self):
        ...
        # plot
        if self.comboBox_sfm_2dmap_axes.currentText() == "Pixel vs. Point":
            self.graphicsView_sfm_2dmap.setImage(self.int_detector_image, axes={'x': 1, 'y': 0}, levels=(0, 0.1),
            ...
            # add ROI rectangular
            spots_ROI = {'x':(int(self.lineEdit_sfm_detector_image_roi_x_left.text()) * int(self.horizontalSlider_sfm_2dmap_rescale_image_x.value()), int(self.lineEdit_sfm_detector_image_roi_x_right.text()) * int(self.horizontalSlider_sfm_2dmap_rescale_image_x.value()), int(self.lineEdit_sfm_detector_image_roi_x_right.text()) * int(self.horizontalSlider_sfm_2dmap_rescale_image_x.value()), int(self.lineEdit_sfm_detector_image_roi_x_left.text()) * int(self.horizontalSlider_sfm_2dmap_rescale_image_x.value()), int(self.lineEdit_sfm_detector_image_roi_x_left.text()) * int(self.horizontalSlider_sfm_2dmap_rescale_image_x.value())), 'y':(0,0,self.int_detector_image.shape[0] * int(self.horizontalSlider_sfm_2dmap_rescale_image_y.value()),self.int_detector_image.shape[0] * int(self.horizontalSlider_sfm_2dmap_rescale_image_y.value()),0)}
            ...
            self.graphicsView_sfm_2dmap.getImageItem().setRect(QtCore.QRectF(min(self.int_detector_image_Aif[0]), min(self.int_detector_image_Aif[1]), abs(min(self.int_detector_image_Aif[0])) + abs(max(self.int_detector_image_Aif[0])), abs(min(self.int_detector_image_Aif[1])) + abs(max(self.int_detector_image_Aif[1]))))
