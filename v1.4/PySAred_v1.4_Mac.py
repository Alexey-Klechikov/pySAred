...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.comboBox_point_number.setGeometry(QtCore.QRect(80, 7, 65, 20))
        ...
        self.label_highlight = QtWidgets.QLabel(self.tab_map)
        self.label_highlight.setFont(font_ee)
        self.label_highlight.setGeometry(QtCore.QRect(5, 8, 50, 16))
        self.label_highlight.setObjectName("label_highlight")
        self.label_highlight.setText("Highlight")
        self.horizontalSlider_highlight = QtWidgets.QSlider(self.tab_map)
        self.horizontalSlider_highlight.setGeometry(QtCore.QRect(55, 7, 190, 22))
        self.horizontalSlider_highlight.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_highlight.setObjectName("horizontalSlider_highlight")
        self.horizontalSlider_highlight.setMinimum(0)
        self.horizontalSlider_highlight.setMaximum(1000)
        self.horizontalSlider_highlight.setValue(40)
        # "scale" for "Qx vs Qz"
        self.label_Qxz_threshold = QtWidgets.QLabel(self.tab_map)
        self.label_Qxz_threshold.setFont(font_ee)
        self.label_Qxz_threshold.setGeometry(QtCore.QRect(5, 8, 220, 16))
        self.label_Qxz_threshold.setObjectName("label_Qxz_threshold")
        self.label_Qxz_threshold.setText("Threshold for the view (number of neutrons):")
        self.label_Qxz_threshold.setVisible(False)
        self.comboBox_Qxz_threshold = QtWidgets.QComboBox(self.tab_map)
        self.comboBox_Qxz_threshold.setFont(font_ee)
        self.comboBox_Qxz_threshold.setGeometry(QtCore.QRect(230, 7, 40, 20))
        self.comboBox_Qxz_threshold.setObjectName("comboBox_Qxz_threshold")
        self.comboBox_Qxz_threshold.addItem("1")
        self.comboBox_Qxz_threshold.addItem("2")
        self.comboBox_Qxz_threshold.addItem("5")
        self.comboBox_Qxz_threshold.addItem("10")
        self.comboBox_Qxz_threshold.setVisible(False)
        self.label_polarisation_2d_map = QtWidgets.QLabel(self.tab_map)
        self.label_polarisation_2d_map.setFont(font_ee)
        self.label_polarisation_2d_map.setGeometry(QtCore.QRect(284, 8, 71, 16))
        ...
        self.comboBox_polarisation_2d_map.setGeometry(QtCore.QRect(344, 7, 40, 20))
        self.comboBox_polarisation_2d_map.setObjectName("comboBox_polarisation")
        self.label_axes = QtWidgets.QLabel(self.tab_map)
        self.label_axes.setFont(font_ee)
        self.label_axes.setGeometry(QtCore.QRect(405, 8, 71, 16))
        self.label_axes.setObjectName("label_axes")
        self.label_axes.setText("Axes")
        self.comboBox_axes = QtWidgets.QComboBox(self.tab_map)
        self.comboBox_axes.setFont(font_ee)
        self.comboBox_axes.setGeometry(QtCore.QRect(435, 7, 130, 20))
        self.comboBox_axes.setObjectName("comboBox_axes")
        self.comboBox_axes.addItem("Pixel vs. Point")
        self.comboBox_axes.addItem("Alpha_i vs. Alpha_f")
        self.comboBox_axes.addItem("Qx vs. Qz")
        ...
        self.label_remove_points_Qxz = QtWidgets.QLabel(self.tab_map)
        self.label_remove_points_Qxz.setFont(font_ee)
        self.label_remove_points_Qxz.setGeometry(QtCore.QRect(5, 561, 211, 16))
        self.label_remove_points_Qxz.setObjectName("label_remove_points_Qxz")
        self.label_remove_points_Qxz.setText("Lower the number of points by factor")
        self.label_remove_points_Qxz.setVisible(False)
        self.comboBox_remove_points_Qxz = QtWidgets.QComboBox(self.tab_map)
        self.comboBox_remove_points_Qxz.setFont(font_ee)
        self.comboBox_remove_points_Qxz.setGeometry(QtCore.QRect(195, 560, 40, 20))
        self.comboBox_remove_points_Qxz.setObjectName("comboBox_remove_points_Qxz")
        self.comboBox_remove_points_Qxz.addItem("5")
        self.comboBox_remove_points_Qxz.addItem("4")
        self.comboBox_remove_points_Qxz.addItem("3")
        self.comboBox_remove_points_Qxz.addItem("2")
        self.comboBox_remove_points_Qxz.addItem("1")
        self.comboBox_remove_points_Qxz.setVisible(False)
        self.label_rescale_image_x = QtWidgets.QLabel(self.tab_map)
        self.label_rescale_image_x.setFont(font_ee)
        self.label_rescale_image_x.setGeometry(QtCore.QRect(5, 561, 80, 16))
        self.label_rescale_image_x.setObjectName("label_rescale_image_x")
        self.label_rescale_image_x.setText("Rescale image: x")
        self.horizontalSlider_rescale_image_x = QtWidgets.QSlider(self.tab_map)
        self.horizontalSlider_rescale_image_x.setGeometry(QtCore.QRect(90, 560, 80, 22))
        self.horizontalSlider_rescale_image_x.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_rescale_image_x.setObjectName("horizontalSlider_rescale_image_x")
        self.horizontalSlider_rescale_image_x.setMinimum(1)
        self.horizontalSlider_rescale_image_x.setMaximum(15)
        self.horizontalSlider_rescale_image_x.setValue(1)
        self.label_rescale_image_y = QtWidgets.QLabel(self.tab_map)
        self.label_rescale_image_y.setFont(font_ee)
        self.label_rescale_image_y.setGeometry(QtCore.QRect(180, 561, 20, 16))
        self.label_rescale_image_y.setObjectName("label_rescale_image_y")
        self.label_rescale_image_y.setText("y")
        self.horizontalSlider_rescale_image_y = QtWidgets.QSlider(self.tab_map)
        self.horizontalSlider_rescale_image_y.setGeometry(QtCore.QRect(190, 560, 80, 22))
        self.horizontalSlider_rescale_image_y.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_rescale_image_y.setObjectName("horizontalSlider_rescale_image_y")
        self.horizontalSlider_rescale_image_y.setMinimum(1)
        self.horizontalSlider_rescale_image_y.setMaximum(15)
        self.horizontalSlider_rescale_image_y.setValue(10)
        self.label_Aif_num_pix = QtWidgets.QLabel(self.tab_map)
        self.label_Aif_num_pix.setFont(font_ee)
        self.label_Aif_num_pix.setGeometry(QtCore.QRect(280, 561, 110, 16))
        self.label_Aif_num_pix.setObjectName("label_Aif_num_pix")
        self.label_Aif_num_pix.setText("Resolution (pixels in Y)")
        self.label_Aif_num_pix.setVisible(False)
        self.lineEdit_Aif_num_pix = QtWidgets.QLineEdit(self.tab_map)
        self.lineEdit_Aif_num_pix.setFont(font_ee)
        self.lineEdit_Aif_num_pix.setGeometry(QtCore.QRect(395, 561, linedit_size_X, linedit_size_Y))
        self.lineEdit_Aif_num_pix.setObjectName("lineEdit_Aif_num_pix")
        self.lineEdit_Aif_num_pix.setText("1000")
        self.lineEdit_Aif_num_pix.setVisible(False)
        self.pushButton_export_2d_map = QtWidgets.QPushButton(self.tab_map)
        self.pushButton_export_2d_map.setGeometry(QtCore.QRect(445, 555, 120, 25))
...
class GUI(Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.lineEdit_SampleLength.editingFinished.connect(self.load_reflectivity_preview)
        ...
        self.lineEdit_AttenCorrFactor.editingFinished.connect(self.load_reflectivity_preview)
        self.checkBox_OverillCorr.stateChanged.connect(self.load_reflectivity_preview)
        self.lineEdit_SkipSubtrBKG.editingFinished.connect(self.load_reflectivity_preview)
        ...
        self.lineEdit_wavelength.editingFinished.connect(self.load_reflectivity_preview)
        self.lineEdit_wavel_resol.editingFinished.connect(self.load_reflectivity_preview)
        self.lineEdit_s1_sample_dist.editingFinished.connect(self.load_reflectivity_preview)
        self.lineEdit_s2_sample_dist.editingFinished.connect(self.load_reflectivity_preview)
        self.lineEdit_full_scan_offset.editingFinished.connect(self.load_reflectivity_preview)
        self.lineEdit_skip_last_points.editingFinished.connect(self.load_reflectivity_preview)
        self.lineEdit_skip_first_points.editingFinished.connect(self.load_reflectivity_preview)
        ...
        self.comboBox_Qxz_threshold.currentIndexChanged.connect(self.draw_2D_map)
        self.comboBox_polarisation_2d_map.currentIndexChanged.connect(self.draw_2D_map)
        self.horizontalSlider_highlight.valueChanged.connect(self.draw_2D_map)
        self.horizontalSlider_rescale_image_x.valueChanged.connect(self.draw_2D_map)
        self.horizontalSlider_rescale_image_y.valueChanged.connect(self.draw_2D_map)
        self.comboBox_axes.currentIndexChanged.connect(self.draw_2D_map)
        self.comboBox_scan.currentIndexChanged.connect(self.draw_2D_map)
        self.lineEdit_wavelength.editingFinished.connect(self.draw_2D_map)
        self.lineEdit_sample_det_dist.editingFinished.connect(self.draw_2D_map)
        self.lineEdit_Aif_num_pix.editingFinished.connect(self.draw_2D_map)
        self.comboBox_remove_points_Qxz.currentIndexChanged.connect(self.draw_2D_map)
    ...
    def draw_2D_map(self):
        ...
        if self.comboBox_axes.currentText() == "Pixel vs. Point":
            self.graphicsView_map_Qxz_Theta.setGeometry(QtCore.QRect(0, 0, 0, 0))
            self.label_highlight.setVisible(True)
            self.horizontalSlider_highlight.setVisible(True)
            self.label_rescale_image_x.setVisible(True)
            self.label_rescale_image_y.setVisible(True)
            self.horizontalSlider_rescale_image_x.setVisible(True)
            self.horizontalSlider_rescale_image_y.setVisible(True)
            self.label_remove_points_Qxz.setVisible(False)
            self.comboBox_remove_points_Qxz.setVisible(False)
            self.label_Qxz_threshold.setVisible(False)
            self.comboBox_Qxz_threshold.setVisible(False)
            self.lineEdit_Aif_num_pix.setVisible(False)
            self.label_Aif_num_pix.setVisible(False)
        elif self.comboBox_axes.currentText() == "Qx vs. Qz":
            self.graphicsView_map_Qxz_Theta.setGeometry(QtCore.QRect(0, 30, 577, 520))
            self.label_remove_points_Qxz.setVisible(True)
            self.comboBox_remove_points_Qxz.setVisible(True)
            self.label_Qxz_threshold.setVisible(True)
            self.comboBox_Qxz_threshold.setVisible(True)
            self.label_rescale_image_x.setVisible(False)
            self.label_rescale_image_y.setVisible(False)
            self.horizontalSlider_rescale_image_x.setVisible(False)
            self.horizontalSlider_rescale_image_y.setVisible(False)
            self.label_highlight.setVisible(False)
            self.horizontalSlider_highlight.setVisible(False)
            self.lineEdit_Aif_num_pix.setVisible(False)
            self.label_Aif_num_pix.setVisible(False)
        elif self.comboBox_axes.currentText() == "Alpha_i vs. Alpha_f":
            self.graphicsView_map_Qxz_Theta.setGeometry(QtCore.QRect(0, 0, 0, 0))
            self.label_highlight.setVisible(True)
            self.horizontalSlider_highlight.setVisible(True)
            self.label_rescale_image_x.setVisible(True)
            ...
            self.horizontalSlider_rescale_image_x.setVisible(True)
            self.horizontalSlider_rescale_image_y.setVisible(True)
            self.label_Aif_num_pix.setVisible(True)
            self.lineEdit_Aif_num_pix.setVisible(True)
            self.label_remove_points_Qxz.setVisible(False)
            self.comboBox_remove_points_Qxz.setVisible(False)
            self.label_Qxz_threshold.setVisible(False)
            self.comboBox_Qxz_threshold.setVisible(False)
        ...
        if not self.SFM_file_2d_calculated_params == [] and not self.SFM_file_2d_calculated_params[0] == self.SFM_file:
            self.comboBox_axes.setCurrentIndex(0)
            self.SFM_file_2d_calculated_params = []
            self.res_Aif = []
        ...
        if self.comboBox_polarisation_2d_map.count() == 1:
            self.int_detector_image = self.I_uu_sfm
        else:
            if self.comboBox_polarisation_2d_map.currentText() == "uu":
                self.int_detector_image = self.I_uu_sfm
            elif self.comboBox_polarisation_2d_map.currentText() == "du":
                self.int_detector_image = self.I_du_sfm
            elif self.comboBox_polarisation_2d_map.currentText() == "ud":
                self.int_detector_image = self.I_ud_sfm
            elif self.comboBox_polarisation_2d_map.currentText() == "dd":
                self.int_detector_image = self.I_dd_sfm

        if self.int_detector_image == []: return

        # Pixel to Angle conversion for "Qx vs Qz" and "alpha_i vs alpha_f" 2d maps
        if self.comboBox_axes.currentText() in ["Qx vs. Qz", "Alpha_i vs. Alpha_f"]:
            # recalculate only if something was changed
            if self.res_Aif == [] or not self.SFM_file_2d_calculated_params == [self.SFM_file, self.comboBox_polarisation_2d_map.currentText(),
                                              self.lineEdit_ROI_x_left.text(), self.lineEdit_ROI_x_right.text(),
                                              self.lineEdit_wavelength.text(), self.lineEdit_sample_det_dist.text(),
                                              self.comboBox_remove_points_Qxz.currentText(), self.comboBox_Qxz_threshold.currentText(),
                                              self.lineEdit_Aif_num_pix.text()]:
                self.spots_Qxz = []
                self.int_detector_image_Qxz = []
                self.int_detector_image_Aif = [[],[]]
                self.int_detector_image_values_array = []

                roi_middle = round((self.int_detector_image.shape[1] - float(self.lineEdit_ROI_x_left.text()) +
                                    self.int_detector_image.shape[1] - float(self.lineEdit_ROI_x_right.text())) / 2)
                mm_per_pix = 300 / self.int_detector_image.shape[1]

                # we need to flip the detector (X) for correct calculation
                for theta_i, tth_i, det_image_i in zip(self.th_motor_data, self.tth_motor_data, numpy.flip(self.int_detector_image, 1)):
                    for pixel_num, value in enumerate(det_image_i):
                        # Reduce number of points to draw (to save RAM)
                        if pixel_num % int(self.comboBox_remove_points_Qxz.currentText()) == 0:
                            # theta F in deg
                            ...
                            delta_theta_F_deg = numpy.degrees(
                                numpy.arctan(delta_theta_F_mm / float(self.lineEdit_sample_det_dist.text())))
                            # final theta F in deg for the point
                            theta_f += delta_theta_F_deg
                            # convert to Q
                            Qx = (2 * numpy.pi / float(self.lineEdit_wavelength.text())) * (
                                        numpy.cos(numpy.radians(theta_f)) - numpy.cos(numpy.radians(theta_i)))
                            Qz = (2 * numpy.pi / float(self.lineEdit_wavelength.text())) * (
                            ...
                            if value < int(self.comboBox_Qxz_threshold.currentText()): color = [0, 0, 255]
                            else: color = [0, 255, 0]

                            self.spots_Qxz.append({'pos': (-Qx, Qz), 'pen': pg.mkPen(color[0], color[1], color[2])})

                if self.res_Aif == [] or self.comboBox_axes.currentText() == "Alpha_i vs. Alpha_f":
                    grid_x, grid_y = numpy.mgrid[min(self.int_detector_image_Aif[0]):max(self.int_detector_image_Aif[0]):((max(self.int_detector_image_Aif[0]) - min(self.int_detector_image_Aif[0]))/len(self.th_motor_data)), min(self.int_detector_image_Aif[1]):max(self.int_detector_image_Aif[1]): (max(self.int_detector_image_Aif[1]) - min(self.int_detector_image_Aif[1]))/int(self.lineEdit_Aif_num_pix.text())]
                    self.res_Aif = griddata((self.int_detector_image_Aif[0], self.int_detector_image_Aif[1]), self.int_detector_image_values_array, (grid_x, grid_y), method="linear")

                # record params that we used for 2D maps calculation
                self.SFM_file_2d_calculated_params = [self.SFM_file, self.comboBox_polarisation_2d_map.currentText(),
                                                      self.lineEdit_ROI_x_left.text(), self.lineEdit_ROI_x_right.text(),
                                                      self.lineEdit_wavelength.text(), self.lineEdit_sample_det_dist.text(),
                                                      self.comboBox_remove_points_Qxz.currentText(), self.comboBox_Qxz_threshold.currentText(),
                                                      self.lineEdit_Aif_num_pix.text()]
        ...
        # plot
        if self.comboBox_axes.currentText() == "Pixel vs. Point":
            self.graphicsView_map.setImage(numpy.flip(self.int_detector_image, axis=0), axes={'x': 1, 'y': 0}, levels=(0, 0.1),
                                           scale=(int(self.horizontalSlider_rescale_image_x.value()), int(self.horizontalSlider_rescale_image_y.value())))
            # add ROI rectangular
            spots_ROI = []

            for i in range(int(self.int_detector_image.shape[0])):
                spots_ROI.append({'y': i * int(self.horizontalSlider_rescale_image_y.value()),
                                  'x': int(self.lineEdit_ROI_x_left.text()) * int(
                                      self.horizontalSlider_rescale_image_x.value())})
                spots_ROI.append({'y': i * int(self.horizontalSlider_rescale_image_y.value()),
                                  'x': int(self.lineEdit_ROI_x_right.text()) * int(
                                      self.horizontalSlider_rescale_image_x.value())})
            ...
            self.graphicsView_map.setImage(numpy.flip(self.res_Aif, axis=1), axes={'x': 0, 'y': 1}, levels=(0, 0.1),
                                            scale=(int(self.horizontalSlider_rescale_image_x.value()), int(self.horizontalSlider_rescale_image_y.value())))
        elif self.comboBox_axes.currentText() == "Qx vs. Qz":
            s0 = pg.ScatterPlotItem(spots=self.spots_Qxz, size=1)
            self.graphicsView_map_Qxz_Theta.addItem(s0)

        self.graphicsView_map.ui.histogram.setHistogramRange(0, self.horizontalSlider_highlight.value())
        self.graphicsView_map.ui.histogram.setLevels(0, self.horizontalSlider_highlight.value())

    def export_2d_map(self):
        if self.comboBox_axes.currentText() == "Pixel vs. Point":
            with open(self.lineEdit_saveAt.text() + self.SFM_file[self.SFM_file.rfind("/") + 1 : -3] + "_" + self.comboBox_polarisation_2d_map.currentText() + " 2D_map(Pixel vs. Point).dat", "w") as new_file_2d_map:
            ...
            with open(self.lineEdit_saveAt.text() + self.SFM_file[self.SFM_file.rfind("/") + 1 : -3] + "_" + self.comboBox_polarisation_2d_map.currentText() + " 2D_map_(Alpha_i vs. Alpha_f)).dat", "w") as new_file_2d_map_Aif:
                # header
        ...
        elif self.comboBox_axes.currentText() in ["Qx vs. Qz"]:
            with open(self.lineEdit_saveAt.text() + self.SFM_file[self.SFM_file.rfind("/") + 1 : -3] + "_" + self.comboBox_polarisation_2d_map.currentText() + " points_(Qx, Qz, intens).dat", "w") as new_file_2d_map_Qxz:
