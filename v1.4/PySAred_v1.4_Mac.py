...
class GUI(Ui_MainWindow):
    ...
    def button_reduce_sfm_scan(self):
        ...
        for i in range(0, len(self.sfm_export_Qz)):
            ...
            with open(self.lineEdit_save_at.text() + self.SFM_FILE[self.SFM_FILE.rfind("/") + 1 : -3] + "_" + str(detector[i]) + " (" + sfm_db_file_export + ")" + " SFM.dat", "w") as new_file:
    ...
    def export_2d_map(self):
        ...
        if self.comboBox_sfm_2dmap_axes.currentText() == "Pixel vs. Point":
            with open(self.lineEdit_save_at.text() + self.SFM_FILE[self.SFM_FILE.rfind("/") + 1 : -3] + "_" + self.comboBox_sfm_2dmap_polarisation.currentText() + " 2D_map(Pixel vs. Point).dat", "w") as new_file_2d_map:
            ...
            with open(self.lineEdit_save_at.text() + self.SFM_FILE[self.SFM_FILE.rfind("/") + 1 : -3] + "_" + self.comboBox_sfm_2dmap_polarisation.currentText() + " 2D_map_(Alpha_i vs. Alpha_f)).dat", "w") as new_file_2d_map_Aif:
                # header
            ...
            with open(self.lineEdit_save_at.text() + self.SFM_FILE[self.SFM_FILE.rfind("/") + 1 : -3] + "_" + self.comboBox_sfm_2dmap_polarisation.currentText() + " points_(Qx, Qz, intens).dat", "w") as new_file_2d_map_Qxz:
