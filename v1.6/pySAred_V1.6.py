# pyinstaller --onefile --noconsole -i"C:\icon.ico" --add-data C:\icon.ico;images C:\pySAred_V1.6.py
...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow_size = [1180, 721] # Mac 1180, 701
        ...
        self.__create_element(self.groupBox_Data, [10, 25, 280, 653], "groupBox_Data", font=font_ee)
        self.label_Data_files = QtWidgets.QLabel(self.groupBox_Data)
        self.__create_element(self.label_Data_files, [110, 6, 121, 21], "label_Data_files", text="Data files", font=font_headline)
        self.tableWidget_Scans = QtWidgets.QTableWidget(self.groupBox_Data)
        self.__create_element(self.tableWidget_Scans, [10, 34, 260, 338], "tableWidget_Scans", font=font_ee)
        ...
        self.__create_element(self.pushButton_Delete_scans, [10, 376, 81, 20], "pushButton_Delete_scans", text="Delete scans", font=font_ee)
        self.pushButton_Import_scans = QtWidgets.QPushButton(self.groupBox_Data)
        self.__create_element(self.pushButton_Import_scans, [189, 376, 81, 20], "pushButton_Import_scans", text="Import scans", font=font_ee)
        self.label_DB_files = QtWidgets.QLabel(self.groupBox_Data)
        self.__create_element(self.label_DB_files, [78, 398, 191, 23], "label_DB_files", text="Direct Beam files", font=font_headline)
        self.checkBox_Rearrange_DB_after = QtWidgets.QCheckBox(self.groupBox_Data)
        self.__create_element(self.checkBox_Rearrange_DB_after, [10, 418, 210, 20], "checkBox_Rearrange_DB_after", text="DB's were measured after the scans", font=font_ee)
        self.tableWidget_DB = QtWidgets.QTableWidget(self.groupBox_Data)
        self.__create_element(self.tableWidget_DB, [10, 438, 260, 183], "tableWidget_DB", font=font_ee)
        ...
        self.__create_element(self.pushButton_Delete_DB, [10, 625, 81, 20], "pushButton_Delete_DB", text="Delete DB", font=font_ee)
        self.pushButton_Import_DB = QtWidgets.QPushButton(self.groupBox_Data)
        self.__create_element(self.pushButton_Import_DB, [189, 625, 81, 20], "pushButton_Import_DB", text="Import DB", font=font_ee)
        ...
        self.__create_element(self.groupBox_Sample_len, [300, 25, 282, 33], "groupBox_Sample_len", font=font_ee)
        self.label_Sample_len = QtWidgets.QLabel(self.groupBox_Sample_len)
        self.__create_element(self.label_Sample_len, [10, 10, 131, 16], "label_Sample_len", text="Sample length (mm)", font=font_ee)
        self.lineEdit_Sample_len = QtWidgets.QLineEdit(self.groupBox_Sample_len)
        self.__create_element(self.lineEdit_Sample_len, [192, 8, 83, 21], "lineEdit_Sample_len", text="50")
        ...
        self.__create_element(self.groupBox_Save_at, [299, 339, 282, 34], "groupBox_Save_at", font=font_ee, title="")
        self.lineEdit_Save_at = QtWidgets.QLineEdit(self.groupBox_Save_at)
        self.__create_element(self.lineEdit_Save_at, [10, 8, 225, 22], "lineEdit_Save_at", font=font_ee, text=self.current_dir)
        self.toolButton_Save_at = QtWidgets.QToolButton(self.groupBox_Save_at)
        self.__create_element(self.toolButton_Save_at, [248, 8, 27, 22], "toolButton_Save_at", font=font_ee, text="...")
        ...
        self.__create_element(self.groupBox_Recheck_files_in_SFM, [299, 512, 282, 166], "groupBox_Recheck_files_in_SFM", font=font_ee, title="")
        self.listWidget_Recheck_files_in_SFM = QtWidgets.QListWidget(self.groupBox_Recheck_files_in_SFM)
        self.__create_element(self.listWidget_Recheck_files_in_SFM, [10, 13, 262, 145], "listWidget_Recheck_files_in_SFM")
        ...
        self.__create_element(self.groupBox_SFM_Scan, [591, 25, 472, 34], "groupBox_SFM_Scan", title="")
        self.label_SFM_Scan = QtWidgets.QLabel(self.groupBox_SFM_Scan)
        self.__create_element(self.label_SFM_Scan, [10, 9, 47, 20], "label_SFM_Scan", font=font_ee, text="Scan")
        self.comboBox_SFM_Scan = QtWidgets.QComboBox(self.groupBox_SFM_Scan)
        self.__create_element(self.comboBox_SFM_Scan, [40, 9, 425, 20], "comboBox_SFM_Scan", font=font_ee)
