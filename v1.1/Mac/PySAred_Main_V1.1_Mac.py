...
class GUI(PySAred_FrontEnd.Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.lineEdit_2d_scale.textChanged.connect(self.draw_2D_map)
    ...
    def load_reflectivity_preview(self):
        ...
        for i in range(0, self.tableWidget_Scans.rowCount()):
            if self.tableWidget_Scans.item(i, 0).text() == self.comboBox_scan.currentText():
                self.SFM_file = self.tableWidget_Scans.item(i, 3).text()
                DB_file_scan = self.tableWidget_Scans.item(i, 2).text()
    ...
    def draw_2D_map(self):
        self.graphicsView_map.clear()
        int_detector_image = []
        if self.SFM_file == "" or self.lineEdit_2d_scale.text() == "": return
        ...
        self.graphicsView_map.ui.histogram.setHistogramRange(0, int(self.lineEdit_2d_scale.text()))
        self.graphicsView_map.ui.histogram.setLevels(0, int(self.lineEdit_2d_scale.text()))
