...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow, parent_path):
        ...
        MainWindow.resize(842, 495)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(842, 495))
        MainWindow.setMaximumSize(QtCore.QSize(842, 495))
        ...
        self.tableWidget_Scans.setGeometry(QtCore.QRect(10, 42, 210, 238))
        ...
        self.tableWidget_Scans.setColumnWidth(0, 115)
        ...
        self.pushButton_importScans.setGeometry(QtCore.QRect(10, 282, 81, 20))
        ...
        self.pushButton_DeleteImportScans.setGeometry(QtCore.QRect(139, 282, 81, 20))
        ...
        self.label_db.setGeometry(QtCore.QRect(68, 305, 191, 21))
        ...
        self.checkBox_db_arrangement_after.setGeometry(QtCore.QRect(10, 320, 210, 20))
        ...
        self.label_SFM.setGeometry(QtCore.QRect(537, 5, 200, 16))
        ...
        self.groupBox_load_scan.setGeometry(QtCore.QRect(531, 3, 302, 49))
        ...
        self.tabWidget_SFM.setGeometry(QtCore.QRect(532, 58, 300, 413))
        ...
        self.label_2d_scale = QtWidgets.QLabel(self.tab_map)
        self.label_2d_scale.setFont(font_ee)
        self.label_2d_scale.setGeometry(QtCore.QRect(10, 8, 70, 16))
        self.label_2d_scale.setObjectName("label_2d_scale")
        self.label_2d_scale.setText("Scale")
        self.lineEdit_2d_scale = QtWidgets.QLineEdit(self.tab_map)
        self.lineEdit_2d_scale.setFont(font_ee)
        self.lineEdit_2d_scale.setGeometry(QtCore.QRect(40, 7, 35, 20))
        self.lineEdit_2d_scale.setObjectName("lineEdit_2d_scale")
        self.lineEdit_2d_scale.setText("40")
        self.label_polarisation_2d_map = QtWidgets.QLabel(self.tab_map)
        self.label_polarisation_2d_map.setFont(font_ee)
        self.label_polarisation_2d_map.setGeometry(QtCore.QRect(94, 8, 71, 16))
        self.label_polarisation_2d_map.setObjectName("label_polarisation")
        self.label_polarisation_2d_map.setText("Pol.")
        self.comboBox_polarisation_2d_map = QtWidgets.QComboBox(self.tab_map)
        self.comboBox_polarisation_2d_map.setFont(font_ee)
        self.comboBox_polarisation_2d_map.setGeometry(QtCore.QRect(114, 7, 40, 20))
        ...
        self.label_axis.setGeometry(QtCore.QRect(175, 8, 71, 16))
        ...
        self.comboBox_axis.setGeometry(QtCore.QRect(200, 7, 90, 20))
        ...
        self.graphicsView_map.setGeometry(QtCore.QRect(0, 30, 300, 370))
