...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        font_headline.setPointSize(11) # Mac 12
        font_headline.setBold(True)

        font_button = QtGui.QFont()
        font_button.setPointSize(10) # Mac 11
        font_button.setBold(True)

        font_graphs = QtGui.QFont()
        font_graphs.setPixelSize(11) # Mac 12
        font_graphs.setBold(False)

        font_ee = QtGui.QFont()
        font_ee.setPointSize(8) # Mac 10
        font_ee.setBold(False)

        # Main Window
        MainWindow.setObjectName("MainWindow")
        MainWindow_size = [1180, 720] # Mac 1180, 700
        ...
        self.__create_element(self.groupBox_Data, [10, 10, 280, 667], "groupBox_Data", font=font_ee)
        self.label_Data_files = QtWidgets.QLabel(self.groupBox_Data)
        self.__create_element(self.label_Data_files, [110, 20, 121, 21], "label_Data_files", text="Data files", font=font_headline)
        self.tableWidget_Scans = QtWidgets.QTableWidget(self.groupBox_Data)
        self.__create_element(self.tableWidget_Scans, [10, 42, 260, 338], "tableWidget_Scans", font=font_ee)
        ...
        self.__create_element(self.pushButton_Delete_scans, [10, 384, 81, 20], "pushButton_Delete_scans", text="Delete scans", font=font_ee)
        self.pushButton_Import_scans = QtWidgets.QPushButton(self.groupBox_Data)
        self.__create_element(self.pushButton_Import_scans, [189, 384, 81, 20], "pushButton_Import_scans", text="Import scans", font=font_ee)
        self.label_DB_files = QtWidgets.QLabel(self.groupBox_Data)
        self.__create_element(self.label_DB_files, [78, 412, 191, 23], "label_DB_files", text="Direct Beam files", font=font_headline)
        self.checkBox_Rearrange_DB_after = QtWidgets.QCheckBox(self.groupBox_Data)
        self.__create_element(self.checkBox_Rearrange_DB_after, [10, 432, 210, 20], "checkBox_Rearrange_DB_after", text="DB's were measured after the scans", font=font_ee)
        self.tableWidget_DB = QtWidgets.QTableWidget(self.groupBox_Data)
        self.__create_element(self.tableWidget_DB, [10, 452, 260, 183], "tableWidget_DB", font=font_ee)
        ...
        self.__create_element(self.pushButton_Delete_DB, [10, 639, 81, 20], "pushButton_Delete_DB", text="Delete DB", font=font_ee)
        self.pushButton_Import_DB = QtWidgets.QPushButton(self.groupBox_Data)
        self.__create_element(self.pushButton_Import_DB, [189, 639, 81, 20], "pushButton_Import_DB", text="Import DB", font=font_ee)
        ...
        self.__create_element(self.groupBox_Sample_len, [300, 10, 282, 47], "groupBox_Sample_len", font=font_ee)
        ...
        self.__create_element(self.lineEdit_Instrument_Wavelength, [220, 10, 41, 18], "lineEdit_Instrument_Wavelength", font=font_ee, text="5.2")
        ...
        self.__create_element(self.lineEdit_Instrument_Distance_sample_to_detector, [220, 102, 41, 18], "lineEdit_Instrument_Distance_sample_to_detector", font=font_ee, text="2500")
        ...
        self.__create_element(self.lineEdit_Instrument_Sample_curvature, [220, 152, 41, 18], "lineEdit_Instrument_Sample_curvature", font=font_ee, text="0")
        self.label_Instrument_Offset_full = QtWidgets.QLabel(self.tab_Instrument_settings)
        self.__create_element(self.label_Instrument_Offset_full, [10, 175, 241, 16], "label_Instrument_Offset_full", font=font_ee, text="Full scan offset (SFM) (th - deg)")
        self.lineEdit_Instrument_Offset_full = QtWidgets.QLineEdit(self.tab_Instrument_settings)
        self.__create_element(self.lineEdit_Instrument_Offset_full, [220, 175, 41, 18], "lineEdit_Instrument_Offset_full", font=font_ee, text="0")
        ...
        self.__create_element(self.checkBox_Export_Add_resolution_column, [10, 10, 250, 18], "checkBox_Export_Add_resolution_column", text="Include ang. resolution column in the output file", font=font_ee, checked=True)
        ...
        self.__create_element(self.label_Error_sample_len_missing, [360, 420, 181, 31], "label_Error_sample_len_missing", font=font_button, text="Sample length is missing", visible=False, stylesheet="color:rgb(255,0,0)")
        self.label_Error_DB_missing = QtWidgets.QLabel(self.centralwidget)
        self.__create_element(self.label_Error_DB_missing, [355, 450, 181, 31], "label_Error_DB_missing", font=font_button, text="Direct beam file is missing", visible=False, stylesheet="color:rgb(255,0,0)")
        self.label_Error_DB_wrong = QtWidgets.QLabel(self.centralwidget)
        self.__create_element(self.label_Error_DB_wrong, [365, 420, 240, 51], "label_Error_DB_wrong", font=font_button, text="Choose another DB file \n for this SFM data file.", visible=False, stylesheet="color:rgb(255,0,0)")
        self.label_Error_Save_at_missing = QtWidgets.QLabel(self.centralwidget)
        self.__create_element(self.label_Error_Save_at_missing, [360, 435, 181, 31], "label_Error_Save_at_missing", font=font_button, text="Define 'Save at' directory", visible=False, stylesheet="color:rgb(255,0,0)")
        self.label_Error_wrong_roi_input = QtWidgets.QLabel(self.centralwidget)
        self.__create_element(self.label_Error_wrong_roi_input, [360, 435, 181, 31], "label_Error_wrong_roi_input", font=font_button, text="Recheck your ROI input", visible=False, stylesheet="color:rgb(255,0,0)")
        ...
        self.__create_element(self.groupBox_Recheck_files_in_SFM, [299, 497, 282, 180], "groupBox_Recheck_files_in_SFM", font=font_ee, title="")
        self.listWidget_Recheck_files_in_SFM = QtWidgets.QListWidget(self.groupBox_Recheck_files_in_SFM)
        self.__create_element(self.listWidget_Recheck_files_in_SFM, [10, 27, 262, 145], "listWidget_Recheck_files_in_SFM")
        ...
        self.__create_element(self.groupBox_SFM_Scan, [591, 10, 472, 48], "groupBox_SFM_Scan", title="")
        self.label_SFM_Scan = QtWidgets.QLabel(self.groupBox_SFM_Scan)
        self.__create_element(self.label_SFM_Scan, [10, 23, 47, 20], "label_SFM_Scan", font=font_ee, text="Scan")
        self.comboBox_SFM_Scan = QtWidgets.QComboBox(self.groupBox_SFM_Scan)
        self.__create_element(self.comboBox_SFM_Scan, [40, 23, 425, 20], "comboBox_SFM_Scan", font=font_ee)
        pg.setConfigOption('background', (255, 255, 255))
        pg.setConfigOption('foreground', 'k')

        # Button: Reduce SFM
        self.pushButton_Reduce_SFM = QtWidgets.QPushButton(self.centralwidget)
        self.__create_element(self.pushButton_Reduce_SFM, [1070, 28, 100, 30], "pushButton_Reduce_SFM", font=font_button, text="Reduce SFM")
        ...
        self.__create_element(self.comboBox_SFM_Detector_image_Incident_angle, [105, 5, 55, 20], "comboBox_SFM_Detector_image_Incident_angle", font=font_ee)
        self.label_SFM_Detector_image_Polarisation = QtWidgets.QLabel(self.tab_SFM_Detector_image)
        self.__create_element(self.label_SFM_Detector_image_Polarisation, [175, 7, 60, 16], "label_SFM_Detector_image_Polarisation", font=font_ee, text="Polarisation")
        self.comboBox_SFM_Detector_image_Polarisation = QtWidgets.QComboBox(self.tab_SFM_Detector_image)
        self.__create_element(self.comboBox_SFM_Detector_image_Polarisation, [235, 5, 40, 20], "comboBox_SFM_Detector_image_Polarisation", font=font_ee)
        self.label_SFM_Detector_image_Color_scheme = QtWidgets.QLabel(self.tab_SFM_Detector_image)
        self.__create_element(self.label_SFM_Detector_image_Color_scheme, [290, 7, 60, 16], "label_SFM_Detector_image_Color_scheme", font=font_ee, text="Colors")
        self.comboBox_SFM_Detector_image_Color_scheme = QtWidgets.QComboBox(self.tab_SFM_Detector_image)
        self.__create_element(self.comboBox_SFM_Detector_image_Color_scheme, [325, 5, 90, 20], "comboBox_SFM_Detector_image_Color_scheme", font=font_ee, combo=["Green / Blue", "White / Black"])
        self.pushButton_SFM_Detector_image_Show_integrated_roi = QtWidgets.QPushButton(self.tab_SFM_Detector_image)
        self.__create_element(self.pushButton_SFM_Detector_image_Show_integrated_roi, [445, 7, 120, 20], "pushButton_SFM_Detector_image_Show_integrated_roi", font=font_ee, text="Integrated ROI")
        ...
        self.__create_element(self.label_SFM_Reflectivity_preview_View, [320, 7, 200, 16], "label_SFM_Reflectivity_preview_View", text="View: Reflectivity                     vs Angle", font=font_ee)
        ...
        self.__create_element(self.label_SFM_2Dmap_Rescale_image_x, [5, 561, 80, 16], "label_SFM_2Dmap_Rescale_image_x", text="Rescale image: x", font=font_ee)
        self.horizontalSlider_SFM_2Dmap_Rescale_image_x = QtWidgets.QSlider(self.tab_2Dmap)
        self.__create_element(self.horizontalSlider_SFM_2Dmap_Rescale_image_x, [90, 560, 80, 22], "horizontalSlider_SFM_2Dmap_Rescale_image_x")
        ...
        self.__create_element(self.label_SFM_2Dmap_Rescale_image_y, [180, 561, 20, 16], "label_SFM_2Dmap_Rescale_image_y", text="y", font=font_ee)
        self.horizontalSlider_SFM_2Dmap_Rescale_image_y = QtWidgets.QSlider(self.tab_2Dmap)
        self.__create_element(self.horizontalSlider_SFM_2Dmap_Rescale_image_y, [190, 560, 80, 22], "horizontalSlider_SFM_2Dmap_Rescale_image_y")
...
class GUI(Ui_MainWindow):
    ...
    def draw_2D_map(self):
        ...
        if self.comboBox_SFM_2Dmap_Axes.currentText() == "Pixel vs. Point":
            ...
            visible = [True, True, True, True, False, False, False, False, True, True]
            ...
            self.graphicsView_SFM_2Dmap_Qxz_Theta.setGeometry(QtCore.QRect(0, 0, 0, 0))
            visible = [False, False, False, False, True, True, False, False, True, True]
                ...
                for theta_i, tth_i, det_image_i in zip(self.th_list, self.tth_list, np.flip(self.int_SFM_Detector_image, 1)):
                    for pixel_num, value in enumerate(det_image_i):
                        ...
                        if pixel_num % int(self.comboBox_SFM_2Dmap_Lower_number_of_points_by.currentText()) == 0:
                            ...
                            delta_theta_F_deg = np.degrees(np.arctan(delta_theta_F_mm / float(self.lineEdit_Instrument_Distance_sample_to_detector.text())))
        ...
        if self.comboBox_SFM_2Dmap_Axes.currentText() == "Pixel vs. Point":
            ...
            self.graphicsView_SFM_2Dmap.setImage(image, axes={'x': 1, 'y': 0}, levels=(0, np.max(image)),
