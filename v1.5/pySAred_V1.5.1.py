...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.__create_element(self.label_Instrument_Offset_full, [10, 175, 241, 16], "label_Instrument_Offset_full", font=font_ee, text="Sample angle offset (th - deg)")
        ...
        self.__create_element(self.checkBox_Export_Resolution_like_sared, [10, 35, 250, 18], "checkBox_Export_Resolution_like_sared", text="Use original 'Sared' way for ang. resolution calc.", font=font_ee, checked=False)
        ...
        self.label_Export_Angle = QtWidgets.QLabel(self.tab_Export_options)
        self.__create_element(self.label_Export_Angle, [10, 85, 70, 18], "label_Export_Angle", font=font_ee, text="Export angle:")
        self.comboBox_Export_Angle = QtWidgets.QComboBox(self.tab_Export_options)
...
class GUI(Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.pushButton_SFM_2Dmap_export.clicked.connect(self.SFM_Map_2D_Export)
        self.pushButton_SFM_Detector_image_Show_integrated_roi.clicked.connect(self.SFM_Detector_image_Draw)

        # Triggers: LineEdits
        self.lineEdit_SFM_Detector_image_Roi_X_Left.editingFinished.connect(self.SFM_Update_ROI)
        self.lineEdit_SFM_Detector_image_Roi_X_Right.editingFinished.connect(self.SFM_Update_ROI)
        self.lineEdit_SFM_Detector_image_Roi_Y_Bottom.editingFinished.connect(self.SFM_Update_ROI)
        self.lineEdit_SFM_Detector_image_Roi_Y_Top.editingFinished.connect(self.SFM_Update_ROI)
        self.lineEdit_SFM_Detector_image_Roi_bkg_X_Right.editingFinished.connect(self.SFM_Update_ROI)
        self.lineEdit_Sample_len.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Reductions_Attenuator_DB.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Reductions_Subtract_bkg_Skip.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Wavelength.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Wavelength_resolution.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Distance_s1_to_sample.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Distance_s2_to_sample.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Offset_full.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_SFM_Reflectivity_preview_Skip_points_Right.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_SFM_Reflectivity_preview_Skip_points_Left.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Wavelength.editingFinished.connect(self.SFM_Map_2D_Draw)
        self.lineEdit_Instrument_Distance_sample_to_detector.editingFinished.connect(self.SFM_Map_2D_Draw)
        self.lineEdit_Reductions_Scale_factor.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Sample_curvature.editingFinished.connect(self.SFM_Reflectivity_preview_Load)
        self.lineEdit_Instrument_Sample_curvature.editingFinished.connect(self.SFM_Map_2D_Draw)

        # Triggers: ComboBoxes
        self.comboBox_SFM_Detector_image_Incident_angle.currentIndexChanged.connect(self.SFM_Detector_image_Draw)
        self.comboBox_SFM_Detector_image_Polarisation.currentIndexChanged.connect(self.SFM_Detector_image_Draw)
        self.comboBox_SFM_Scan.currentIndexChanged.connect(self.SFM_Detector_image_Load)
        self.comboBox_SFM_Scan.currentIndexChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.comboBox_SFM_Reflectivity_preview_View_Angle.currentIndexChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.comboBox_SFM_Reflectivity_preview_View_Reflectivity.currentIndexChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.comboBox_SFM_2Dmap_Qxz_Threshold.currentIndexChanged.connect(self.SFM_Map_2D_Draw)
        self.comboBox_SFM_2Dmap_Polarisation.currentIndexChanged.connect(self.SFM_Map_2D_Draw)
        self.comboBox_SFM_2Dmap_Axes.currentIndexChanged.connect(self.SFM_Map_2D_Draw)
        self.comboBox_SFM_Scan.currentIndexChanged.connect(self.SFM_Map_2D_Draw)
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.currentIndexChanged.connect(self.SFM_Map_2D_Draw)
        self.comboBox_SFM_Detector_image_Color_scheme.currentIndexChanged.connect(self.SFM_Detector_image_Draw)
        self.comboBox_Reductions_Divide_by_monitor_or_time.currentIndexChanged.connect(self.db_analaze)
        self.comboBox_Reductions_Divide_by_monitor_or_time.currentIndexChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.comboBox_SFM_2Dmap_View_scale.currentIndexChanged.connect(self.SFM_Map_2D_Draw)
        self.comboBox_Export_Angle.currentIndexChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.comboBox_SFM_DB.currentIndexChanged.connect(self.SFM_Reflectivity_preview_Load)

        # Triggers: CheckBoxes
        self.checkBox_Reductions_Divide_by_monitor_or_time.stateChanged.connect(self.db_analaze)
        self.checkBox_Reductions_Divide_by_monitor_or_time.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Reductions_Normalize_by_DB.stateChanged.connect(self.db_analaze)
        self.checkBox_Reductions_Normalize_by_DB.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Reductions_Attenuator_DB.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Reductions_Overillumination_correction.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Reductions_Subtract_bkg.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Reductions_Subtract_bkg.stateChanged.connect(self.SFM_Detector_image_Draw)
        self.checkBox_SFM_Reflectivity_preview_Show_overillumination.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_SFM_Reflectivity_preview_Show_zero_level.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_SFM_Reflectivity_preview_Include_errorbars.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Rearrange_DB_after.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Rearrange_DB_after.stateChanged.connect(self.db_assign)
        self.checkBox_Reductions_Scale_factor.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Export_Resolution_like_sared.stateChanged.connect(self.SFM_Reflectivity_preview_Load)
        self.checkBox_Export_Add_resolution_column.stateChanged.connect(self.SFM_Reflectivity_preview_Load)

        # Triggers: Sliders
        self.horizontalSlider_SFM_2Dmap_Rescale_image_x.valueChanged.connect(self.SFM_Map_2D_Draw)
        self.horizontalSlider_SFM_2Dmap_Rescale_image_y.valueChanged.connect(self.SFM_Map_2D_Draw)
    ...
    def button_import_remove_scans(self):
        ...
        if self.sender().objectName() == "pushButton_Import_scans":
            ...
            for FILE in import_files[0]:
                ...
                self.db_analaze()
                self.SFM_Reflectivity_preview_Load()
    ...
    def button_import_remove_db(self):
        ...
        if self.sender().objectName() == "pushButton_Import_DB":
            ...
            for FILE in remove_files: self.tableWidget_DB.removeRow(self.tableWidget_DB.row(FILE))
            ...
            with h5py.File(self.tableWidget_Scans.item(i, 2).text(), 'r') as FILE:
                ...
                for detector in INSTRUMENT.get('detectors'):
                    ...
                    for index, th in enumerate(th_list):
                        ...
                        if self.checkBox_Export_Resolution_like_sared.isChecked():
                            Resolution = np.sqrt(
                                ((2 * np.pi / float(self.lineEdit_Instrument_Wavelength.text())) ** 2) * ((np.cos(np.radians(th))) ** 2) * (0.68 ** 2) * ((s1hg ** 2) + (s2hg ** 2)) / (
                                            (float(self.lineEdit_Instrument_Distance_s1_to_sample.text()) - float(self.lineEdit_Instrument_Distance_s2_to_sample.text())) ** 2) + (
                            ...
                            if self.comboBox_Export_Angle.currentText() == "Qz":
                                ...
                                Resolution = np.sqrt((k_0 ** 2) * (
                                            (((np.cos(np.radians(th))) ** 2) * d_alpha ** 2) + ((float(self.lineEdit_Instrument_Wavelength_resolution.text()) ** 2) * ((np.sin(np.radians(th))) ** 2))))
                        ...
                        new_file.write(str(angle) + ' ' + str(Intens) + ' ' + str(Intens_err) + ' ')
    ...
    ##--> SFM
    def SFM_Detector_image_Load(self):
    ...
    def SFM_Detector_image_Draw(self):
    ...
    def SFM_Reflectivity_preview_Load(self):
        ...
        self.checkBox_Export_Resolution_like_sared.setEnabled(True if self.checkBox_Export_Add_resolution_column.isChecked() else False)
        ...
        if self.checkBox_Reductions_Overillumination_correction.isChecked() or self.checkBox_SFM_Reflectivity_preview_Show_overillumination.isChecked():
            try:
                _ = float(self.lineEdit_Sample_len.text())
            except:
        ...
        if self.lineEdit_Reductions_Subtract_bkg_Skip.text():
            try:
                skip_bkg = float(self.lineEdit_Reductions_Subtract_bkg_Skip.text())
            except:
                self.statusbar.showMessage("Error: Recheck 'Skip background' field.")

        try:
            _ = 1/float(self.lineEdit_Instrument_Wavelength.text())
            _ = float(self.lineEdit_Instrument_Wavelength_resolution.text())
            _ = float(self.lineEdit_Instrument_Distance_s1_to_sample.text())
            _ = float(self.lineEdit_Instrument_Distance_s2_to_sample.text())
            _ = float(self.lineEdit_Instrument_Distance_sample_to_detector.text())
            _ = float(self.lineEdit_Instrument_Sample_curvature.text())
            _ = float(self.lineEdit_Instrument_Offset_full.text())
        except:
            ...
            for color_index, scan_intens_sfm in enumerate([self.psd_uu_sfm, self.psd_du_sfm, self.psd_ud_sfm, self.psd_dd_sfm]):
                ...
                for index, th in enumerate(self.th_list):
                    ...
                    if self.checkBox_Export_Resolution_like_sared.isChecked():
                        ...
                        if self.comboBox_Export_Angle.currentText() == "Qz":
                            k_0 = 2 * np.pi / float(self.lineEdit_Instrument_Wavelength.text())
                            Resolution = np.sqrt((k_0 ** 2) * ( (((np.cos(np.radians(th))) ** 2) * d_alpha ** 2) + ((float(self.lineEdit_Instrument_Wavelength_resolution.text()) ** 2) * ((np.sin(np.radians(th))) ** 2))))
                        else: Resolution = d_alpha if self.comboBox_Export_Angle.currentText() == "Radians" else np.degrees(d_alpha)
    ...
    def SFM_Update_ROI(self):
        ...
        self.SFM_Detector_image_Draw()
        self.SFM_Reflectivity_preview_Load()
        self.SFM_Map_2D_Draw()
