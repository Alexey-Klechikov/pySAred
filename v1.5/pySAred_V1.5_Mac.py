...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_Instrument_Wavelength.setGeometry(QtCore.QRect(220, 10, 41, 18))
        ...
        self.label_Instrument_Wavelength_resolution.setGeometry(QtCore.QRect(10, 33, 271, 16))
        ...
        self.lineEdit_Instrument_Wavelength_resolution.setGeometry(QtCore.QRect(220, 33, 41, 18))
        ...
        self.label_Instrument_Distance_s1_to_sample.setGeometry(QtCore.QRect(10, 56, 241, 16))
        ...
        self.lineEdit_Instrument_Distance_s1_to_sample.setGeometry(QtCore.QRect(220, 56, 41, 18))
        ...
        self.label_Instrument_Distance_s2_to_sample.setGeometry(QtCore.QRect(10, 79, 241, 16))
        ...
        self.lineEdit_Instrument_Distance_s2_to_sample.setGeometry(QtCore.QRect(220, 79, 41, 18))
        ...
        self.label_Instrument_Distance_sample_to_detector.setGeometry(QtCore.QRect(10, 102, 241, 16))
        ...
        self.lineEdit_Instrument_Distance_sample_to_detector.setGeometry(QtCore.QRect(220, 102, 41, 18))
        ...
        self.label_Instrument_Sample_curvature_correction = QtWidgets.QLabel(self.tab_Instrument_settings)
        self.label_Instrument_Sample_curvature_correction.setGeometry(QtCore.QRect(10, 152, 241, 16))
        self.label_Instrument_Sample_curvature_correction.setFont(font_ee)
        self.label_Instrument_Sample_curvature_correction.setObjectName("label_Instrument_Sample_curvature_correction")
        self.label_Instrument_Sample_curvature_correction.setText("Samples curvature (SFM) (rad)")
        self.lineEdit_Instrument_Sample_curvature_correction = QtWidgets.QLineEdit(self.tab_Instrument_settings)
        self.lineEdit_Instrument_Sample_curvature_correction.setGeometry(QtCore.QRect(220, 152, 41, 18))
        self.lineEdit_Instrument_Sample_curvature_correction.setFont(font_ee)
        self.lineEdit_Instrument_Sample_curvature_correction.setObjectName("lineEdit_Instrument_Sample_curvature_correction")
        self.lineEdit_Instrument_Sample_curvature_correction.setText("0")
        ...
        self.label_Instrument_Offset_full.setText("Full scan offset (SFM) (th - deg)")
        self.lineEdit_Instrument_Offset_full = QtWidgets.QLineEdit(self.tab_Instrument_settings)
        self.lineEdit_Instrument_Offset_full.setGeometry(QtCore.QRect(220, 175, 41, 18))
        ...
        self.groupBox_SFM_Scan.setObjectName("groupBox_SFM_Scan")
        ...
        self.comboBox_SFM_Scan.setObjectName("comboBox_SFM_Scan")
        ...
        self.label_SFM_Detector_image_Incident_angle.setFont(font_ee)
        self.label_SFM_Detector_image_Incident_angle.setGeometry(QtCore.QRect(10, 7, 100, 16))
        self.label_SFM_Detector_image_Incident_angle.setObjectName("label_SFM_Detector_image_Incident_angle")
        self.label_SFM_Detector_image_Incident_angle.setText("Incident ang. (deg)")
        self.comboBox_SFM_Detector_image_Incident_angle = QtWidgets.QComboBox(self.tab_SFM_Detector_image)
        self.comboBox_SFM_Detector_image_Incident_angle.setFont(font_ee)
        self.comboBox_SFM_Detector_image_Incident_angle.setGeometry(QtCore.QRect(105, 5, 55, 20))
        self.comboBox_SFM_Detector_image_Incident_angle.setObjectName("comboBox_SFM_Detector_image_Incident_angle")
        ...
        self.label_SFM_Detector_image_Polarisation.setGeometry(QtCore.QRect(175, 7, 60, 16))
        ...
        self.comboBox_SFM_Detector_image_Polarisation.setGeometry(QtCore.QRect(235, 5, 40, 20))
        ...
        self.label_SFM_Detector_image_Color_scheme.setGeometry(QtCore.QRect(290, 7, 60, 16))
        ...
        self.comboBox_SFM_Detector_image_Color_scheme.setGeometry(QtCore.QRect(325, 5, 90, 20))
        ...
        self.checkBox_SFM_Detector_image_Lock_roi.setFont(font_ee)
        self.checkBox_SFM_Detector_image_Lock_roi.setGeometry(QtCore.QRect(38, 545, 50, 16))
        self.checkBox_SFM_Detector_image_Lock_roi.setObjectName("checkBox_SFM_Detector_image_Lock_roi")
        self.checkBox_SFM_Detector_image_Lock_roi.setText("lock):")
        ...
        self.label_SFM_Detector_image_Roi_X_Left.setGeometry(QtCore.QRect(85, 545, 51, 16))
        ...
        self.lineEdit_SFM_Detector_image_Roi_X_Left.setGeometry(QtCore.QRect(115, 544, linedit_size_X, linedit_size_Y))
        ...
        self.label_SFM_Detector_image_Roi_X_Right.setGeometry(QtCore.QRect(85, 565, 51, 16))
        ...
        self.lineEdit_SFM_Detector_image_Roi_X_Right.setGeometry(QtCore.QRect(115, 564, linedit_size_X, linedit_size_Y))
        ...
        self.label_SFM_Detector_image_Roi_Y_Bottom.setGeometry(QtCore.QRect(155, 545, 51, 16))
        ...
        self.lineEdit_SFM_Detector_image_Roi_Y_Bottom.setGeometry(QtCore.QRect(195, 544, linedit_size_X, linedit_size_Y))
        ...
        self.label_SFM_Detector_image_Roi_Y_Top.setGeometry(QtCore.QRect(155, 565, 51, 16))
        ...
        self.lineEdit_SFM_Detector_image_Roi_Y_Top.setGeometry(QtCore.QRect(195, 564, linedit_size_X, linedit_size_Y))
        ...
        self.label_SFM_Detector_image_Roi_bkg.setGeometry(QtCore.QRect(245, 545, 47, 16))
        self.label_SFM_Detector_image_Roi_bkg.setObjectName("label_SFM_Detector_image_Roi_bkg")
        self.label_SFM_Detector_image_Roi_bkg.setText("BKG:")
        ...
        self.label_SFM_Detector_image_Roi_bkg_X_Left.setGeometry(QtCore.QRect(270, 545, 51, 16))
        ...
        self.lineEdit_SFM_Detector_image_Roi_bkg_X_Left.setGeometry(QtCore.QRect(300, 544, linedit_size_X, linedit_size_Y))
        ...
        self.label_SFM_Detector_image_Roi_bkg_X_Right.setGeometry(QtCore.QRect(270, 565, 51, 16))
        ...
        self.lineEdit_SFM_Detector_image_Roi_bkg_X_Right.setGeometry(QtCore.QRect(300, 564, linedit_size_X, linedit_size_Y))
        ...
        self.label_SFM_Detector_image_Time.setGeometry(QtCore.QRect(350, 545, 71, 16))
        ...
        self.lineEdit_SFM_Detector_image_Time.setGeometry(QtCore.QRect(400, 544, linedit_size_X, linedit_size_Y))
        ...
        self.label_SFM_Detector_image_Slits.setGeometry(QtCore.QRect(450, 545, 51, 16))
        ...
        self.label_SFM_Detector_image_Slits_s1hg.setGeometry(QtCore.QRect(505, 545, 41, 16))
        ...
        self.lineEdit_SFM_Detector_image_Slits_s1hg.setGeometry(QtCore.QRect(535, 544, linedit_size_X, linedit_size_Y))
        ...
        self.lineEdit_SFM_Detector_image_Slits_s2hg.setGeometry(QtCore.QRect(535, 564, linedit_size_X, linedit_size_Y))
        ...
        self.checkBox_SFM_Reflectivity_preview_Show_overillumination.setGeometry(QtCore.QRect(10, 6, 140, 18))
        ...
        self.checkBox_SFM_Reflectivity_preview_Show_zero_level.setFont(font_ee)
        self.checkBox_SFM_Reflectivity_preview_Show_zero_level.setGeometry(QtCore.QRect(150, 6, 150, 18))
        self.checkBox_SFM_Reflectivity_preview_Show_zero_level.setObjectName("checkBox_SFM_Reflectivity_preview_Show_zero_level")
        self.checkBox_SFM_Reflectivity_preview_Show_zero_level.setText("Show Zero level")

        self.label_SFM_Reflectivity_preview_View = QtWidgets.QLabel(self.tab_SFM_Reflectivity_preview)
        self.label_SFM_Reflectivity_preview_View.setFont(font_ee)
        self.label_SFM_Reflectivity_preview_View.setGeometry(QtCore.QRect(320, 7, 200, 16))
        self.label_SFM_Reflectivity_preview_View.setObjectName("label_SFM_Reflectivity_preview_View")
        self.label_SFM_Reflectivity_preview_View.setText("View: Reflectivity                     vs Angle")
        self.comboBox_SFM_Reflectivity_preview_View_Reflectivity = QtWidgets.QComboBox(self.tab_SFM_Reflectivity_preview)
        self.comboBox_SFM_Reflectivity_preview_View_Reflectivity.setFont(font_ee)
        self.comboBox_SFM_Reflectivity_preview_View_Reflectivity.setGeometry(QtCore.QRect(410, 5, 50, 20))
        self.comboBox_SFM_Reflectivity_preview_View_Reflectivity.setObjectName("comboBox_SFM_Reflectivity_preview_View_Reflectivity")
        self.comboBox_SFM_Reflectivity_preview_View_Reflectivity.addItem("Log")
        self.comboBox_SFM_Reflectivity_preview_View_Reflectivity.addItem("Lin")
        self.comboBox_SFM_Reflectivity_preview_View_Angle = QtWidgets.QComboBox(self.tab_SFM_Reflectivity_preview)
        self.comboBox_SFM_Reflectivity_preview_View_Angle.setFont(font_ee)
        self.comboBox_SFM_Reflectivity_preview_View_Angle.setGeometry(QtCore.QRect(515, 5, 50, 20))
        self.comboBox_SFM_Reflectivity_preview_View_Angle.setObjectName("comboBox_SFM_Reflectivity_preview_View_Angle")
        self.comboBox_SFM_Reflectivity_preview_View_Angle.addItem("Qz")
        self.comboBox_SFM_Reflectivity_preview_View_Angle.addItem("Deg")
        ...
        self.label_SFM_2Dmap_Qxz_Threshold.setGeometry(QtCore.QRect(5, 7, 220, 16))
        ...
        self.comboBox_SFM_2Dmap_Qxz_Threshold.setGeometry(QtCore.QRect(230, 5, 40, 20))
        ...
        self.label_SFM_2Dmap_View_scale.setFont(font_ee)
        self.label_SFM_2Dmap_View_scale.setGeometry(QtCore.QRect(183, 7, 40, 16))
        self.label_SFM_2Dmap_View_scale.setObjectName("label_SFM_2Dmap_View_scale")
        self.label_SFM_2Dmap_View_scale.setText("View")
        self.comboBox_SFM_2Dmap_View_scale = QtWidgets.QComboBox(self.tab_2Dmap)
        self.comboBox_SFM_2Dmap_View_scale.setFont(font_ee)
        self.comboBox_SFM_2Dmap_View_scale.setGeometry(QtCore.QRect(210, 5, 50, 20))
        self.comboBox_SFM_2Dmap_View_scale.setObjectName("comboBox_SFM_2Dmap_View_scale")
        self.comboBox_SFM_2Dmap_View_scale.addItem("Log")
        self.comboBox_SFM_2Dmap_View_scale.addItem("Lin")
        self.label_SFM_2Dmap_Polarisation = QtWidgets.QLabel(self.tab_2Dmap)
        self.label_SFM_2Dmap_Polarisation.setFont(font_ee)
        self.label_SFM_2Dmap_Polarisation.setGeometry(QtCore.QRect(284, 7, 71, 16))
        ...
        self.comboBox_SFM_2Dmap_Polarisation.setGeometry(QtCore.QRect(344, 5, 40, 20))
        ...
        self.label_SFM_2Dmap_Axes.setGeometry(QtCore.QRect(405, 7, 71, 16))
        ...
        self.comboBox_SFM_2Dmap_Axes.setGeometry(QtCore.QRect(435, 5, 130, 20))
        ...
        colmap = pg.ColorMap(numpy.array([0, 0.3333, 0.6666, 1]), numpy.array([[0, 0, 0, 255],[185, 0, 0, 255],[255, 220, 0, 255], [255, 255, 255, 255]], dtype=numpy.ubyte))
        ...
        self.label_SFM_2Dmap_Lower_number_of_points_by.setFont(font_ee)
        self.label_SFM_2Dmap_Lower_number_of_points_by.setGeometry(QtCore.QRect(5, 561, 211, 16))
        self.label_SFM_2Dmap_Lower_number_of_points_by.setObjectName("label_SFM_2Dmap_Lower_number_of_points_by")
        self.label_SFM_2Dmap_Lower_number_of_points_by.setText("Lower the number of points by factor")
        self.label_SFM_2Dmap_Lower_number_of_points_by.setVisible(False)
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by = QtWidgets.QComboBox(self.tab_2Dmap)
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.setFont(font_ee)
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.setGeometry(QtCore.QRect(195, 559, 40, 20))
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.setObjectName("comboBox_SFM_2Dmap_Lower_number_of_points_by")
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.addItem("5")
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.addItem("4")
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.addItem("3")
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.addItem("2")
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.addItem("1")
        self.comboBox_SFM_2Dmap_Lower_number_of_points_by.setVisible(False)
...
class GUI(Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.lineEdit_Instrument_Sample_curvature_correction.editingFinished.connect(self.load_SFM_Reflectivity_preview)
        self.lineEdit_Instrument_Sample_curvature_correction.editingFinished.connect(self.draw_2D_map)
    ...
    def load_SFM_Detector_images(self):
        ...
        with h5py.File(self.SFM_FILE, 'r') as FILE:
            ...
            if not self.locked_roi == [] and self.checkBox_SFM_Detector_image_Lock_roi.isChecked(): original_roi_coord = numpy.array(self.locked_roi[0])
            else: original_roi_coord = numpy.array(SCAN.get("instrument").get('scalers').get('roi').get("roi"))
    ...
    def load_SFM_Reflectivity_preview(self):
        ...
        with h5py.File(self.SFM_FILE, 'r') as FILE:
            ...
            for scan in PONOS.get('data'):
                ...
                if self.SFM_FILE == self.sfm_file_already_analized and str(self.sample_curvature_last) == self.lineEdit_Instrument_Sample_curvature_correction.text(): continue
            ...
            if not str(self.sample_curvature_last) == self.lineEdit_Instrument_Sample_curvature_correction.text():

                for index, scan_intens_sfm_for_correction in enumerate([self.psd_uu_sfm, self.psd_du_sfm, self.psd_ud_sfm, self.psd_dd_sfm]):

                    if self.lineEdit_Instrument_Sample_curvature_correction.text() == "0": continue
                    if scan_intens_sfm_for_correction == []: continue

                    recalc_det_image = [[],[],[]] # x, y, value

                    for x, col in enumerate(numpy.flipud(numpy.rot90(scan_intens_sfm_for_correction))):
                        displacement = x * numpy.tan(float(self.lineEdit_Instrument_Sample_curvature_correction.text()))
                        for y, value in enumerate(col):
                            y_new = y + displacement
                            recalc_det_image[0].append(x)
                            recalc_det_image[1].append(y_new)
                            recalc_det_image[2].append(value)
                    numpy.rot90(scan_intens_sfm_for_correction, -1)

                    # find middle of roi to define zero level
                    roi_coord_X_middle = (roi_coord_X[0] + roi_coord_X[1]) / 2
                    zero_level = int(round(roi_coord_X_middle * numpy.tan(float(self.lineEdit_Instrument_Sample_curvature_correction.text())) - min(recalc_det_image[1])))

                    grid_x, grid_y = numpy.mgrid[0:scan_intens_sfm_for_correction.shape[1]:1, min(recalc_det_image[1]):max(recalc_det_image[1]):1]
                    scan_intens_sfm_for_correction = numpy.flipud(numpy.rot90(griddata((recalc_det_image[0], recalc_det_image[1]), recalc_det_image[2], (grid_x, grid_y), method="linear", fill_value=float(0))))[zero_level:zero_level+scan_intens_sfm_for_correction.shape[0], :]

                    if index == 0: self.psd_uu_sfm = scan_intens_sfm_for_correction
                    elif index == 1: self.psd_du_sfm = scan_intens_sfm_for_correction
                    elif index == 2: self.psd_ud_sfm = scan_intens_sfm_for_correction
                    elif index == 3: self.psd_dd_sfm = scan_intens_sfm_for_correction

                self.sample_curvature_last = str(self.lineEdit_Instrument_Sample_curvature_correction.text())
            ...
            for color_index, scan_intens_sfm in enumerate([self.psd_uu_sfm, self.psd_du_sfm, self.psd_ud_sfm, self.psd_dd_sfm]):
                ...
                if self.checkBox_SFM_Reflectivity_preview_Show_zero_level.isChecked():
                    if self.comboBox_SFM_Reflectivity_preview_View_Reflectivity.currentText() == "Lin":
                        level = numpy.array([1, 1])
                    else: level = numpy.array([0, 0])
                    s4 = pg.PlotCurveItem(x=numpy.array([min(plot_angle), max(plot_angle)]), y=level, pen=pg.mkPen(color=(0, 0, 255), width=1), brush=pg.mkBrush(color=(255, 0, 0), width=1) )
    ...
    def draw_2D_map(self):
        ...
        if self.comboBox_SFM_2Dmap_Axes.currentText() == "Pixel vs. Point":
            ...
            self.label_SFM_2Dmap_Qxz_Threshold.setVisible(False)
            self.comboBox_SFM_2Dmap_Qxz_Threshold.setVisible(False)
            self.label_SFM_2Dmap_View_scale.setVisible(True)
            self.comboBox_SFM_2Dmap_View_scale.setVisible(True)
            ...
            self.label_SFM_2Dmap_Lower_number_of_points_by.setVisible(True)
            self.comboBox_SFM_2Dmap_Lower_number_of_points_by.setVisible(True)
            ...
            self.label_SFM_2Dmap_View_scale.setVisible(False)
            self.comboBox_SFM_2Dmap_View_scale.setVisible(False)
        ...
        self.int_SFM_Detector_image_log = numpy.log10(numpy.where(self.int_SFM_Detector_image < 1, 0.1, self.int_SFM_Detector_image))
        ...
        if self.comboBox_SFM_2Dmap_Axes.currentText() in ["Qx vs. Qz", "Alpha_i vs. Alpha_f"]:
            ...
            if self.res_Aif == [] or not self.sfm_file_2d_calculated_params == [self.SFM_FILE, self.comboBox_SFM_2Dmap_Polarisation.currentText(),
                                              ...
                                              self.comboBox_SFM_2Dmap_Lower_number_of_points_by.currentText(), self.comboBox_SFM_2Dmap_Qxz_Threshold.currentText(),
                                                                                self.lineEdit_Instrument_Sample_curvature_correction.text()]:
                self.spots_Qxz = []
                ...
                for theta_i, tth_i, det_image_i in zip(self.th_list, self.tth_list, numpy.flip(self.int_SFM_Detector_image, 1)):
                    for pixel_num, value in enumerate(det_image_i):
                        ...
                        if pixel_num % int(self.comboBox_SFM_2Dmap_Lower_number_of_points_by.currentText()) == 0:
                            ...
                            delta_theta_F_deg = numpy.degrees(numpy.arctan(delta_theta_F_mm / float(self.lineEdit_Instrument_Distance_sample_to_detector.text())))
                ...
                if self.comboBox_SFM_2Dmap_Axes.currentText() == "Alpha_i vs. Alpha_f":
                    ...
                    # create log array for log view
                    self.res_Aif_log = numpy.log10(numpy.where(self.res_Aif < 1, 0.1, self.res_Aif))
        ...
        if self.comboBox_SFM_2Dmap_Axes.currentText() == "Pixel vs. Point":
            ...
            if self.comboBox_SFM_2Dmap_View_scale.currentText() == "Log": image = self.int_SFM_Detector_image_log
            else: image = self.int_SFM_Detector_image

            self.graphicsView_SFM_2Dmap.setImage(image, axes={'x': 1, 'y': 0}, levels=(0, numpy.max(image)),
            ...
            if self.comboBox_SFM_2Dmap_View_scale.currentText() == "Log": image = self.res_Aif_log
            else: image = self.res_Aif

            self.graphicsView_SFM_2Dmap.setImage(image, axes={'x': 0, 'y': 1}, levels=(0, numpy.max(image)))
        ...
        self.graphicsView_SFM_2Dmap.view.getAxis("left").setTicks(None)
        self.graphicsView_SFM_2Dmap.view.getAxis("bottom").setTicks(None)
